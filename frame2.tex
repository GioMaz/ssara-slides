...
\node (entry) at (0, 0) [draw, label=left:$B_0$] {
    $\textcolor<8->{\cbnodeB}{r_0} \leftarrow 5$ \\
    $\textcolor<9->{\cbnodeC}{r_1} \leftarrow 10$ \\
    if $\textcolor<8->{\cbnodeB}{r_0} < \textcolor<9->{\cbnodeC}{r_1}$
};
\node (b1) at (-1.7, -1.4) [draw, label=left:$B_1$] {
    $\textcolor<10->{\cbnodeA}{r_2} \leftarrow \textcolor<8->{\cbnodeB}{r_0} + 1$
};
\node (b2) at (1.7, -1.4) [draw, label=right:$B_2$] {
    $\textcolor<11->{\cbnodeA}{r_3} \leftarrow \textcolor<8->{\cbnodeB}{r_0} + 2$
};
\node (end) at (0, -2.85) [draw, label=left:$B_3$] {
    $\textcolor<12->{\cbnodeA}{r_4} \leftarrow \phi(\textcolor<10->{\cbnodeA}{r_2}, \textcolor<11->{\cbnodeA}{r_3})$ \\
    $\textcolor<13->{\cbnodeB}{r_5} \leftarrow \textcolor<8->{\cbnodeB}{r_0} + \textcolor<9->{\cbnodeC}{r_1}$ \\
    ret $\textcolor<12->{\cbnodeA}{r_4}$
};
\draw[->] (entry) -- (b1);
\draw[->] (entry) -- (b2);
\draw[->] (b1) -- (end);
...
\node<8->[fill=\cbnodeB!60] (r0) at (0,0) {$r_0$};
\node<9->[fill=\cbnodeC!60] (r1) at (2,-2) {$r_1$};
\node<11->[fill=\cbnodeA!60] (r2) at (0,-2) {$r_2$};
\node<10->[fill=\cbnodeA!60] (r3) at (2,0) {$r_3$};
\node<12->[fill=\cbnodeA!60] (r4) at (-2,0) {$r_4$};
\node<13->[fill=\cbnodeB!60] (r5) at (-2,-2) {$r_5$};
